...
import { Language, TouristProfile, ItineraryItem, ChatMessage, BroadcastAlert } from '../types';
import { i18n } from '../data/i18n';
import { POLICE_STATIONS, INITIAL_TOURISTS, INITIAL_BROADCASTS } from '../data/mockData';
...
export const TouristPortal: React.FC<TouristPortalProps> = ({
  ...
  useEffect(() => {
    ...
    if (countdown !== null && countdown > 0) {
      ...
      onTriggerSos(authenticatedUser ? authenticatedUser.name : 'Registered Tourist', currentAddress);
    }
    return () => clearInterval(timer);
  }, [countdown, currentAddress, onTriggerSos, authenticatedUser]);
        ...
        <div className="space-y-5 text-left">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 items-start">
            ...
            <div className="lg:col-span-5 space-y-5">
                  ...
                  {sosActive ? (
                    ...
                    <div className="flex flex-col items-center">
                      ...
                      <p className="mt-3 text-[11px] text-slate-500 font-medium max-w-xs text-center">
                        Tap button to send instant distress signal & live location to nearest PCR unit.
                      </p>
                    </div>
                  )}
                </div>
              ...
              {/* BOX 2 BOTTOM LEFT: GOOGLE MAPS FOR DIRECTIONS AND LOCATION */}
              <div className="bg-white border-2 border-slate-200 rounded-2xl p-4 shadow-sm space-y-3 text-left">
                ...
                <div className="space-y-3">
                  ...
                  <ActualGoogleMap
                    ...
                    height="230px"
                    markers={[
                      { id: 'user-loc', lat, lng, title: 'My GPS Location', type: 'user' },
                  ...
                  <div className="flex items-center justify-between text-[10px] text-slate-500 bg-slate-50 p-2 rounded-xl border border-slate-200 font-semibold">
                    <span>Route: <strong>28.4 km (42 mins)</strong></span>
